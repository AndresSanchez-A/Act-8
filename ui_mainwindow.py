...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.spinBox_4, 1, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.spinBox_3, 2, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.spinBox_2, 3, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.spinBox, 4, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_8, 7, 2, 1, 3)

        self.spinBox_5 = QSpinBox(self.groupBox)
        self.spinBox_5.setObjectName(u"spinBox_5")

        self.gridLayout.addWidget(self.spinBox_5, 7, 5, 1, 1)

        self.label_9 = QLabel(self.groupBox)
        self.label_9.setObjectName(u"label_9")

        self.gridLayout.addWidget(self.label_9, 8, 2, 1, 3)

        self.spinBox_6 = QSpinBox(self.groupBox)
        self.spinBox_6.setObjectName(u"spinBox_6")

        self.gridLayout.addWidget(self.spinBox_6, 8, 5, 1, 1)

        self.label_10 = QLabel(self.groupBox)
        self.label_10.setObjectName(u"label_10")

        self.gridLayout.addWidget(self.label_10, 9, 2, 1, 3)

        self.spinBox_7 = QSpinBox(self.groupBox)
        self.spinBox_7.setObjectName(u"spinBox_7")

        self.gridLayout.addWidget(self.spinBox_7, 9, 5, 1, 1)
        ...
        self.menubar.setGeometry(QRect(0, 0, 286, 21))
